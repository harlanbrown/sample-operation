 ...
 */
@Operation(id = CustomDownloadFile.ID, category = Constants.CAT_UI, requires = Constants.SEAM_CONTEXT, label = "Download file", description = "Download a file", aliases = {
        "WebUI.DownloadFile" })
public class CustomDownloadFile {

    protected static Log log = LogFactory.getLog(CustomDownloadFile.class);

    public static final String ID = "Custom.DownloadFile";
